        ...
        >
          ...
          >
            ...
            <div className="w-1/2 flex flex-col justify-between">
              <div className="text-xl">{giftCard.title}</div>
              <div className="">{giftCard.price}</div>
              <div className="">
                <button className="flex justify-center items-center border border-indigo-800 w-full rounded py-2 text-white uppercase bg-indigo-800">
                  Buy
                </button>
              </div>
            </div>
